...
const btnAcciones = (index) => {
  ...
  const btnAnadir = `<button id="aprobar-${index}" class="action-btn approve-btn" onclick="aprobar(${index})">Aprobar</button>`;
  const btnRevertir = `<button id="revertir-${index}" class="action-btn revert-btn" onclick="revertir(${index})" disabled>Revertir</button>`;
  const btnBorrar = `<button id="borrar-${index}" class="action-btn delete-btn" onclick="borrar(${index})">Borrar</button>`;
